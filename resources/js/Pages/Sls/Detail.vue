<template>
  <AppLayout :title="`Detail SLS: ${item.kode_sls}`">
    <div class="flex items-center gap-2 mb-5">
      <Link :href="route('sls.index')" class="btn btn-secondary">
        <i class="fas fa-arrow-left" style="font-size:11px"></i> Kembali
      </Link>
      <Link :href="route('sls.edit', item.id)" class="btn btn-warning">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-4">
      <div class="card">
        <div class="card-header">
          <h2 class="card-title">Info SLS</h2>
        </div>
...
const infoRows = computed(() => [
  { label: 'Kode SLS', value: props.item.kode_sls, mono: true },
  { label: 'Nama SLS', value: props.item.nama_sls },
